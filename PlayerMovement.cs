...
public class PlayerMovement : MonoBehaviour
{
    ...
    void PlayerDied(string name)
    {
        List<string> dList = new List<string>
        {
            ...
            " Got the Needle-Farts", 
            " Didn't look left and right",
            " Licked an icy pole", 
            " Got chopped In the Neck",
            " Got chopped In the Throat",
            " Didn't Raise Their Hand To Speak",
            " Forgot To Pray this Morning", 
            " Wasn't Important",
            " Checked their Watch at the Wrong Time",
            " Didn't have Enough Lunch Money",
            " Got the Bubble Guts",
            " Met Ashiah and died of a lowered IQ",
            " Got kicked In Their Chest",
            " Got Kicked In Their Shin",
            " Got A Kick To The Balls (Or Tits, your choice)",
            " Didn't Bend Their Knees", 
            " Went Broke",
            " Wore the Wrong Shoes",
            " Got Bitten By a Turtle",
            " Caught a Cold",
            " Got stuck by a Pencil",
            " Tripped",
            " Tried To Run",
            " Wasn't Ready", 
            " Didn't Make it To The Restroom", 
            " Died of Dehydration from Seeing Dat Booty", 
            " Didn't Pray hard Enough",
            " Prayed hard Enough, But for The Wrong Thing",
            " Had a Prostate Exam From an Unlicensed Doctor", 
            " Was Top-Heavy",
            " Walked The Wrong Way",
            " Broke Their Toes",
            " Headbutted a Laser",
            " Trued To Wrassle With a hale",
            " Got hit With a Brick",
            " Tried To Lift Too Much Weight",
            " Taseted the Forbidden Flavor",
            " Needs a Band-Aid",
            " Should Really Get ice For That",
            " Jizzed In Threir Pants",
            " Used literally Instead of Figuratively",
            " Used then instead of than in the YouTube comment section",
            " Forgot how to Move On",
            " Attempted to be a Male Seahorse",
            " Didn't Want it bad Enough",
            " Desearved to Suffer",
            " Needed more Vespen Gas",
            " Didn't pay Child Support",
            " Required Additional Pylons",
            " Lost the Game",
            " Wasn't Tall Enough to Ride",
            " Tried to be Friendly To a Creeper",
            " Needs a Tutorial",
            " Didn't Duck the Incomming Duck", 
            " Didnt Press X fast Enough",
            " Didn't Beware The Ides Of March",
            " Tried To Do A Backflip",
            " Had a Sudden Realization",
            " Found out Their Girl was Cheating",
            " Got Their Girl Stolen",
            " Drank a Birthday Cake Milkshake", 
            " Couldn't Find Any #### To Give",
